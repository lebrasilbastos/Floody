...
// ==========================================
// COMPONENTE PRINCIPAL (WORKSPACE)
// ==========================================
function MainApp({ user, onLogout }) {
  ...
  return (
    <div className="floody-pro-layout">
      ...
      {/* 🧭 SIDEBAR LATERAL (APENAS PARA DESKTOP) */}
      ...
      {/* 📱 BARRA DE NAVEGAÇÃO INFERIOR PARA MOBILE (ESTILO APLICATIVO NATIVO) */}
      {user.tipo !== 'admin' && (
